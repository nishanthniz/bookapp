...
export class RegisterComponent implements OnInit {
  ...
  checkPasswordStrength(inputPassword) {
    ...
    let password_strength_bar: any = document.getElementsByClassName('pwd-progress-bar')[0];
    //TextBox left blank.
    ...
    let weakPwdRegex: RegExp = /^(?=.*[a-zA-Z0-9])(?=.*[!@#\$%\^&\*])(?=.{2,})/
    //Regular Expressions.
    ...
    switch (regPassed) {
      ...
      case 2:
        ...
        break;
      case 3:
        password_strength_bar.style.width = "90%";
